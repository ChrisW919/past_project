...
public class PollRepositoryImpl implements PollRepository {
    ...
    @Override
    @Transactional(readOnly = true)
    public int voteCount(String answer) {
        final String SQL_COUNT_VOTE = "select count(answer) as totalvote from pollanswer where answer = ?";
        return jdbcOp.queryForObject(SQL_COUNT_VOTE,new java.lang.Object[]{answer},Integer.class);
    }
}
