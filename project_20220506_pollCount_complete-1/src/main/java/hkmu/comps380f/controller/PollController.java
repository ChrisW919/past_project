...
public class PollController {
    ...
    public ModelAndView view(@PathVariable("pollId") long pollId, ModelMap model,
        ...
        model.addAttribute("opt1Count", pollRepo.voteCount("opt1"));
        model.addAttribute("opt2Count", pollRepo.voteCount("opt2"));
        model.addAttribute("opt3Count", pollRepo.voteCount("opt3"));
        model.addAttribute("opt4Count", pollRepo.voteCount("opt4"));
        if (!ans.isEmpty()) {
